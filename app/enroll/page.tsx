    ...
    return (
        <>
                ...
                <div>
                    <form className="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <TextInput id="email1" type="email" placeholder="Enter Email" required/>
                        </div>
                        <div>
                            <div className="mb-2 block">
                            ...
                            <TextInput id="username3" placeholder="Enter Phone Number" addon="+855" required/>
                        </div>
                        <div>
                            <div className="mb-2 block ">
            ...
            <div className="flex justify-end gap-4 mt-10">
                ...
                <button type="submit"
                    className="w-40 bg-transparent hover:bg-green-500 text-green-700 font-semibold hover:text-white py-2 px-4 border border-green-500 hover:border-transparent rounded uppercase transition duration-500 ease-in-out">
                    Enroll Now
                </button>
            </div>
        </div>
