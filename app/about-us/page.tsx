...
export default function AboutUs() {
    ...
    return (
        <div className="container mx-auto grid grid-cols-1 gap-4 my-8">
            <div className="bg-white p-6 grid grid-cols-1 gap-2 mr-20 ml-20">
                <h1 className="flex items-center text-center text-xl font-bold tracking-[0.25rem]">
                    <FaTerminal/>
            ...
            <div className="bg-white p-6 grid grid-cols-1 gap-2 ml-20 mr-20">
            ...
            <h1 className="uppercase text-xl font-bold text-center text-primary tracking-[0.25rem] ">IF YOU HAVE ANY
